...
{
    //-- déclaration d'objet --// 
    FonctionBinaire entreeA, entreeB, sortie;
	...
	//-- entree A --//
    //-- info litteral --//
   // std::cout << " A " << " | " << entreeA << " | " << valeurBinaire << std::endl << std::endl;
    ...
    //-- entree B --// 
    //-- info litteral --//
   // std::cout << " B " << " | " << entreeB << " | " << valeurBinaire << std::endl << std::endl;
    ...
    //-- Sortie --// 
    //-- info litteral --//
   // std::cout << " Sortie " << " | " << sortie << " | " << valeurBinaire << std::endl << std::endl;
