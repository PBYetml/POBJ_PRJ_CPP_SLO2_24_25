...
int main()
{
	...
	//string choices[] = { "1) pour une fonction AND", "2) pour une fonction OR", "3) pour une fonction XOR"};
	////int mode;
	//
	////-- déclaration d'objet allocation dynamique --// 
	////FonctionBinaire *Resolution; 
	////e_FonctionBinaire Mode{};
	...
	//	 
	//	std::cout << "Veuillez choisir une fonction binaire :" << endl;
	//	for (int i = 0; i < 2; i++) {
	//		cout << setw(2) << choices[i]<< endl;
	//	}
	//	//-- récupération choix utilisateur --// 
	//	//choix non fonctionelle
	//	//std::cin >> Mode;
	//
